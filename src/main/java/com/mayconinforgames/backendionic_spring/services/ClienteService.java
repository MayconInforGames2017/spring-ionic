...
import com.mayconinforgames.backendionic_spring.dto.ClienteDTO;
...
public class ClienteService {
	...
	public void delete(Integer id) {
		...
		try {
			...
			throw new DataIntegrityViolationException("Não é possível excluir um Cliente que possua pedidos");
		}
	}
