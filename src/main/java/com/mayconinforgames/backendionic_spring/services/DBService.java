...
import com.mayconinforgames.backendionic_spring.domain.Cidade;
...
import com.mayconinforgames.backendionic_spring.domain.PagamentoComCartao;
import com.mayconinforgames.backendionic_spring.domain.Pedido;
import com.mayconinforgames.backendionic_spring.domain.Produto;
import com.mayconinforgames.backendionic_spring.domain.enums.EstadoPagamento;
...
import com.mayconinforgames.backendionic_spring.repositories.CidadeRepository;
import com.mayconinforgames.backendionic_spring.repositories.ClienteRepository;
import com.mayconinforgames.backendionic_spring.repositories.EnderecoRepository;
import com.mayconinforgames.backendionic_spring.repositories.EstadoRepository;
import com.mayconinforgames.backendionic_spring.repositories.ItemPedidoRepository;
import com.mayconinforgames.backendionic_spring.repositories.PagamentoRepository;
import com.mayconinforgames.backendionic_spring.repositories.PedidoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "maria@gmail.com", "36789999900", TipoCliente.PESSOAFISICA);
		cli1.getTelefones().addAll(Arrays.asList("27890090", "99998888"));

		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "389000890", cli1, cid1);
		Endereco e2 = new Endereco(null, "Avenida", "105", "Sala 800", "Centro", "38777012", cli1, cid2);
